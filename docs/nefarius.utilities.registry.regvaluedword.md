...
Inheritance [Object](https://learn.microsoft.com/dotnet/api/system.object) → [RegValue](./nefarius.utilities.registry.regvalue.md) → [RegValueDword](./nefarius.utilities.registry.regvaluedword.md)
